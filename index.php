...
$workExperience = [
    [
        ...
        'data1' => 'Январь 2022',
        'data2' => 'Май 2022',
        'discription' => 'Контроль качества изготавливаемой продукции.'
    ],
    [
        'name' => 'Кондитер',
        'data1' => 'Январь 2021',
        'data2' => 'Ноябрь 2021',
        'discription' => 'Изготовление продукции.'
    ],
    [
        'name' => 'Кондитер',
        'data1' => 'Январь 2020',
      ...
      <div class="w3-container w3-card w3-white w3-margin-bottom">
        ...
        <?php for ($i = 0; $i < count($workExperience); $i++): ?>
            <div class="w3-container">
                ...
                <h6 class="w3-text-teal"><i class="fa fa-calendar fa-fw w3-margin-right"></i><?php echo $workExperience[$i]['data1']; ?> - <?php echo $workExperience[$i]['data2']; ?></h6>
                <p><?php echo $workExperience[$i]['discription']; ?></p>
                <hr>
            </div>
        <?php endfor; ?>
      </div>
